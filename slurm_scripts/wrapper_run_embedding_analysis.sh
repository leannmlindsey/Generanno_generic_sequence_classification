...
# Wrapper script for running GENERanno embedding analysis on Biowulf
#
# Usage:
...
# Default uses the base pretrained model from HuggingFace
export MODEL_PATH="GenerTeam/GENERanno-prokaryote-0.5b-base"
...
echo "=========================================="
echo "Submitting GENERanno Embedding Analysis Job"
echo "=========================================="
