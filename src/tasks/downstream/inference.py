"""
Inference Script for GENERanno

This script performs inference on a CSV file using a fine-tuned model.
...
Output CSV format:
    ...
    - pred_label: Predicted label (argmax)
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run inference on CSV file with fine-tuned model"
    )
    parser.add_argument(
        "--input_csv",
        type=str,
